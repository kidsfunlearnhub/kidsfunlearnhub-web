// --- 1. Base Devanagari Digit Paths (० - ९) ---
// Identical to Hindi, used for Marathi numerals
const baseDigits = {
    ...
    '2': ["M 30 60 C 30 20 80 20 80 60 C 80 100 30 120 40 160 C 50 180 80 160 80 140"], // २ (Don)
    ...
    '5': ["M 30 40 C 30 100 80 100 80 60 L 80 160"], // ५ (Pach)
    '6': ["M 70 40 C 20 40 20 100 50 100 C 10 100 10 160 50 160 C 80 160 80 120 50 120"], // ६ (Saha)
    '7': ["M 40 60 C 40 40 60 40 60 60 C 60 80 40 100 40 120 C 40 150 70 150 70 150"], // ७ (Sat)
    '8': ["M 80 40 C 10 60 10 140 80 160"], // ८ (Ath)
...
// Automatically build numbers 1 to 40
const numberData = [];
for (let i = 1; i <= 40; i++) {
    ...
    numberData.push({
        number: strNum,
        paths: finalPaths,
        // CRITICAL UPDATE: Looking for Marathi audio files (e.g., 1_mr.mp3, 22_mr.mp3)
        audioFile: `${i}_mr.mp3` 
    });
}
...
async function openCard(cardElement, itemData) {
    ...
    currentAudio = new Audio(`sounds/mr/numbers/${itemData.audioFile}`);
