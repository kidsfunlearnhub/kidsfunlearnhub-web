...
window.onload = function() {
    ...
    let themeIndex = parseInt(sessionStorage.getItem('tapSmallAbcThemeIndex')) || 0;
    ...
    let score = parseInt(sessionStorage.getItem('tapSmallAbcScore')) || 0;
    ...
    function advanceToNextRound() {
        ...
        if (roundsPlayedThisSession >= ROUNDS_BEFORE_RELOAD) {
            sessionStorage.setItem('tapSmallAbcScore', score);
            sessionStorage.setItem('tapSmallAbcThemeIndex', (themeIndex + 1) % themes.length);
